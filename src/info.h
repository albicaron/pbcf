...
{
public:
	pinfo() { pbd = 1.0; pb = .5; alpha = .95; beta = .5; tau = 1.0; sigma = 1.0; minperbot = 5; var = .005; eta = 1.0; gamma = 1.0 ; taccept = 0; tavgd = 0; tmaxd = 0; }
//mcmc info
...
// Eta and Gamma for latent variables
  double var;
  double eta;
  double gamma;
